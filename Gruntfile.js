// Generated on 2014-07-02 using generator-ionic 0.3.6
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      fonts: {
        expand: true,
        cwd: 'app/vendor/ionic/release/fonts/',
    ...
    karma: {
      options: {
        ...
        files: [
          '<%= yeoman.app %>/vendor/angular/angular.js',
          '<%= yeoman.app %>/vendor/angular-animate/angular-animate.js',
          '<%= yeoman.app %>/vendor/angular-sanitize/angular-sanitize.js',
          '<%= yeoman.app %>/vendor/angular-ui-router/release/angular-ui-router.js',
          '<%= yeoman.app %>/vendor/ionic/release/js/ionic.js',
          '<%= yeoman.app %>/vendor/ionic/release/js/ionic-angular.js',
          '<%= yeoman.app %>/vendor/angular-mocks/angular-mocks.js',
          '<%= yeoman.app %>/<%= yeoman.scripts %>/**/*.js',
          'test/mock/**/*.js',
          'test/spec/**/*.js'
        ],
